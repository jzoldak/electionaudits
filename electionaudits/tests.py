...
class TestSWDB_csv_KM(TestCaseDiff):
    def test_csv(self):
        ...
        # figure out how to get the right margin lookups here, perhaps clearer errors
        ...
        response = self.client.get('/kmselections/1/')
        self.failUnlessEqual(response.status_code, 200)
        self.failDiffUnlessEqual("../testdata/kmselections-1.html", response.content, "/kmselections/1/")
